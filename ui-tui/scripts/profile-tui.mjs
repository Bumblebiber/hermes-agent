...
const baseProps = streamingText => ({
  ...
  status: { cwdLabel: '~/repo', projectName: 'Hermes Agent', goodVibesTick: 0, sessionStartedAt: Date.now(), showStickyPrompt: false, statusColor: theme.color.ok, stickyPrompt: '', turnStartedAt: Date.now(), voiceLabel: 'voice off' },
  transcript: {
    historyItems,
    scrollRef,
